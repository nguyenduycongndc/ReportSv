...
namespace Report_service.Models.MigrationsModels
{
    ...
    public class AuditWork
    {
        public AuditWork()
        {
            ...
            this.AuditDetect = new HashSet<AuditDetect>();
            this.MainStage = new HashSet<MainStage>();
        ...
        public double? NumOfWorkdays { get; set; }
        ...
        public virtual ICollection<AuditDetect> AuditDetect { get; set; }
        public virtual ICollection<MainStage> MainStage { get; set; }
    }
}

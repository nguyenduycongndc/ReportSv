...
namespace Report_service.Migrations
{
    ...
    partial class KitanoSqlContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Audit_service.Models.MigrationsModels.ConfigDocument", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Report_service.Models.MigrationsModels.ApprovalFunctionFile", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Report_service.Models.MigrationsModels.AuditDetect", b =>
                {
                    ...
                    b.Property<int?>("admin_framework")
                        .HasColumnType("integer")
                        .HasColumnName("admin_framework");
            ...
            modelBuilder.Entity("Report_service.Models.MigrationsModels.AuditMinutes", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("audit_work_classify")
                        .HasColumnType("integer")
                        .HasColumnName("audit_work_classify");

                    b.Property<int>("audit_work_person")
                        .HasColumnType("integer")
                        .HasColumnName("audit_work_person");

                    b.Property<string>("audit_work_taget")
                        .HasColumnType("text")
                        .HasColumnName("audit_work_taget");
                    ...
                    b.Property<int?>("rating_level_total")
                        .HasColumnType("integer")
                        .HasColumnName("rating_level_total");
                    ...
                    b.HasIndex("audit_work_person");

                    b.HasIndex("auditfacilities_id");

                    b.HasIndex("auditwork_id");

                    b.ToTable("AUDIT_MINUTES");
                });
            ...
            modelBuilder.Entity("Report_service.Models.MigrationsModels.SystemCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Report_service.Models.MigrationsModels.AuditMinutes", b =>
                {
                    b.HasOne("Report_service.Models.MigrationsModels.Users", "Users")
                        .WithMany()
                        .HasForeignKey("audit_work_person")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
